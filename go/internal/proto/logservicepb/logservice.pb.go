...
type GetAllCollectionIDsToCompactRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *GetAllCollectionIDsToCompactRequest) Reset() {
	*x = GetAllCollectionIDsToCompactRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetAllCollectionIDsToCompactRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAllCollectionIDsToCompactRequest) ProtoMessage() {}

func (x *GetAllCollectionIDsToCompactRequest) ProtoReflect() protoreflect.Message {
	mi := &file_chromadb_proto_logservice_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAllCollectionIDsToCompactRequest.ProtoReflect.Descriptor instead.
func (*GetAllCollectionIDsToCompactRequest) Descriptor() ([]byte, []int) {
	return file_chromadb_proto_logservice_proto_rawDescGZIP(), []int{4}
}

type GetAllCollectionIDsToCompactResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetAllCollectionIDsToCompactResponse) Reset() {
	*x = GetAllCollectionIDsToCompactResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetAllCollectionIDsToCompactResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAllCollectionIDsToCompactResponse) ProtoMessage() {}

func (x *GetAllCollectionIDsToCompactResponse) ProtoReflect() protoreflect.Message {
	mi := &file_chromadb_proto_logservice_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAllCollectionIDsToCompactResponse.ProtoReflect.Descriptor instead.
func (*GetAllCollectionIDsToCompactResponse) Descriptor() ([]byte, []int) {
	return file_chromadb_proto_logservice_proto_rawDescGZIP(), []int{5}
}

func (x *GetAllCollectionIDsToCompactResponse) GetCollectionIds() []string {
	if x != nil {
...
var file_chromadb_proto_logservice_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x6f, 0x2f, 0x6c, 0x6f, 0x67, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x70, 0x62, 0x62, 0x06,
...
var file_chromadb_proto_logservice_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_chromadb_proto_logservice_proto_goTypes = []interface{}{
	...
	(*GetAllCollectionIDsToCompactRequest)(nil),  // 4: chroma.GetAllCollectionIDsToCompactRequest
	(*GetAllCollectionIDsToCompactResponse)(nil), // 5: chroma.GetAllCollectionIDsToCompactResponse
	(*coordinatorpb.SubmitEmbeddingRecord)(nil),  // 6: chroma.SubmitEmbeddingRecord
}
var file_chromadb_proto_logservice_proto_depIdxs = []int32{
	6, // 0: chroma.PushLogsRequest.records:type_name -> chroma.SubmitEmbeddingRecord
	6, // 1: chroma.PullLogsResponse.records:type_name -> chroma.SubmitEmbeddingRecord
	...
	4, // 4: chroma.LogService.GetAllCollectionIDsToCompact:input_type -> chroma.GetAllCollectionIDsToCompactRequest
	1, // 5: chroma.LogService.PushLogs:output_type -> chroma.PushLogsResponse
	3, // 6: chroma.LogService.PullLogs:output_type -> chroma.PullLogsResponse
	5, // 7: chroma.LogService.GetAllCollectionIDsToCompact:output_type -> chroma.GetAllCollectionIDsToCompactResponse
...
func file_chromadb_proto_logservice_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_chromadb_proto_logservice_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAllCollectionIDsToCompactRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chromadb_proto_logservice_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAllCollectionIDsToCompactResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
