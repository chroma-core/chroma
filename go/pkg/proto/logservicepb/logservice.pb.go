...
type GetAllCollectionInfoToCompactRequest struct {
	...
	MinCompactionSize int64 `protobuf:"varint,1,opt,name=min_compaction_size,json=minCompactionSize,proto3" json:"min_compaction_size,omitempty"`
}
...
func (x *GetAllCollectionInfoToCompactRequest) GetMinCompactionSize() int64 {
	if x != nil {
...
var file_chromadb_proto_logservice_proto_rawDesc = []byte{
	...
	0x7a, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x11, 0x6d, 0x69, 0x6e, 0x43, 0x6f, 0x6d,
