...
const (
	...
	SysDB_GetCollectionWithSegments_FullMethodName      = "/chroma.SysDB/GetCollectionWithSegments"
...
type SysDBClient interface {
	...
	GetCollectionWithSegments(ctx context.Context, in *GetCollectionWithSegmentsRequest, opts ...grpc.CallOption) (*GetCollectionWithSegmentsResponse, error)
...
func (c *sysDBClient) GetCollectionWithSegments(ctx context.Context, in *GetCollectionWithSegmentsRequest, opts ...grpc.CallOption) (*GetCollectionWithSegmentsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCollectionWithSegmentsResponse)
	err := c.cc.Invoke(ctx, SysDB_GetCollectionWithSegments_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SysDBServer interface {
	...
	GetCollectionWithSegments(context.Context, *GetCollectionWithSegmentsRequest) (*GetCollectionWithSegmentsResponse, error)
...
func (UnimplementedSysDBServer) GetCollectionWithSegments(context.Context, *GetCollectionWithSegmentsRequest) (*GetCollectionWithSegmentsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCollectionWithSegments not implemented")
}
...
func _SysDB_GetCollectionWithSegments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCollectionWithSegmentsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SysDBServer).GetCollectionWithSegments(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SysDB_GetCollectionWithSegments_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SysDBServer).GetCollectionWithSegments(ctx, req.(*GetCollectionWithSegmentsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SysDB_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetCollectionWithSegments",
			Handler:    _SysDB_GetCollectionWithSegments_Handler,
		},
		{
