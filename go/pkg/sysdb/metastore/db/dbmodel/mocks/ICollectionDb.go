...
// GetCompactionDLQSize provides a mock function with no fields
func (_m *ICollectionDb) GetCompactionDLQSize() (int64, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetCompactionDLQSize")
	}
