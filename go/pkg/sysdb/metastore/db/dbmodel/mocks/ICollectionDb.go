...
func (_m *ICollectionDb) UpdateLogPositionAndVersionInfo(collectionID string, logPosition int64, currentCollectionVersion int32, currentVersionFileName string, newCollectionVersion int32, newVersionFileName string, totalRecordsPostCompaction uint64, sizeBytesPostCompaction uint64, lastCompactionTimeSecs int64) (int64, error) {
	...
	var r0 int64
	var r1 error
	if rf, ok := ret.Get(0).(func(string, int64, int32, string, int32, string, uint64, uint64, int64) (int64, error)); ok {
	...
	if rf, ok := ret.Get(0).(func(string, int64, int32, string, int32, string, uint64, uint64, int64) int64); ok {
	...
	if rf, ok := ret.Get(1).(func(string, int64, int32, string, int32, string, uint64, uint64, int64) error); ok {
