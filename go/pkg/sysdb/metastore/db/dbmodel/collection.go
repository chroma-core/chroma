...
type ICollectionDb interface {
	GetCollections(collectionIDs []string, collectionName *string, tenantID string, databaseID string, limit *int32, offset *int32, includeSoftDeleted bool) ([]*CollectionAndMetadata, error)
	GetCollectionEntries(id *string, name *string, tenantID string, databaseID string, limit *int32, offset *int32) ([]*CollectionAndMetadata, error)
	...
	GetSoftDeletedCollections(collectionID *string, tenantID string, databaseID string, limit int32) ([]*CollectionAndMetadata, error)
