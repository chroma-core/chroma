...
func TestConvertCollectionToModel(t *testing.T) {
	...
	collectionNumRecordsLastCompaction := int64(100)
	collectionAndMetadata := &dbmodel.CollectionAndMetadata{
		Collection: &dbmodel.Collection{
			...
			NumRecordsLastCompaction: &collectionNumRecordsLastCompaction,
		},
	...
	assert.Equal(t, collectionNumRecordsLastCompaction, *modelCollections[0].NumRecordsLastCompaction)
