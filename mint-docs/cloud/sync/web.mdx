...
<Frame><img src="/sync/sync_web_new_db.png" alt="Create database screen" /></Frame>

Then, select the Web source during onboarding:

<Frame><img src="/sync/sync_web_onboarding.png" alt="Onboarding screen" /></Frame>

Next, configure the Web source by providing a starting URL:

<Frame><img src="/sync/sync_web_url_config.png" alt="Web source config" /></Frame>
...
<Frame><img src="/sync/sync_web_advanced_config.png" alt="Web source config" /></Frame>

You can also change the default collection name if you want. After clicking "Create Sync Source", an initial sync will start:

<Frame><img src="/sync/sync_web_progress.png" alt="Web sync in progress" /></Frame>
