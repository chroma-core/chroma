...
2. **New database setup**
    ...
    <Frame><img src="/images/sync/sync_create_database.png" alt="Create database screen" /></Frame>

    On the setup screen, select "Sync a GitHub repo":

    <Frame><img src="/images/sync/sync_new_db_onboarding.png" alt="Onboarding screen for syncing a GitHub repo" /></Frame>

    Install the Chroma GitHub App into your GitHub account or organization:

    <Frame><img src="/images/sync/sync_new_db_github_install.png" alt="GitHub app installation screen" /></Frame>
    ...
    <Frame><img src="/images/sync/sync_install.png" alt="/sync repo to Chroma Collection UI" /></Frame>
...
3. **Existing database setup**
    ...
    <Frame><img src="/images/sync/sync_existing_db.png" alt="/sync tab in Chroma Cloud UI" /></Frame>
    ...
    <Frame><img src="/images/sync/sync_existing_db_add.png" alt="Create path for a new Sync" /></Frame>
    ...
    <Frame><img src="/images/sync/sync_existing_db_sync.png" alt="Create flow for a new Sync" /></Frame>
...
4. **Viewing an Invocation**
    ...
    <Frame><img src="/images/sync/db_invocation.png" alt="Invocation screen for a Sync" /></Frame>
...
1. **Prerequisites**
    ...
    <Frame><img src="/images/sync/gh-contents.png" alt="GitHub App contents" /></Frame>

    <Frame><img src="/images/sync/gh-metadata.png" alt="GitHub App metadata" /></Frame>
...
2. **Setup**
    ...
    <Frame><img src="/images/sync/api_keys.png" alt="API key issuance for Chroma Cloud" /></Frame>
    ...
    <Frame><img src="/images/sync/github_app_id.png" alt="GitHub App ID" /></Frame>

    <Frame><img src="/images/sync/github_secret_key.png" alt="GitHub Secret Key" /></Frame>
    ...
    <Frame><img src="/images/sync/platform_setup.png" alt="Platform setup" /></Frame>

    On the "Connect your custom GitHub app" screen, submit the App ID and private key from GitHub:

    <Frame><img src="/images/sync/custom-github-app-screen.png" alt="Creating a custom github app" /></Frame>
...
4. **Invoking the Sync Function**
    ...
    <Frame><img src="/images/sync/custom_source_invocation.png" alt="Creating a custom sync invocation" /></Frame>
