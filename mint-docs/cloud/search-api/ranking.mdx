...
description: Use ranking expressions to score and order search results.
---

Use ranking expressions to score and order your search results. In Chroma, lower scores indicate better matches (distance-based scoring).
