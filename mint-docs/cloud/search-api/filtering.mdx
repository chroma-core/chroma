...
description: Filter search results using Where expressions and the Key/K class.
---

Filter search results using Where expressions and the Key/K class to narrow down your search to specific documents, IDs, or metadata values.
