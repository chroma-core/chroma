---
title: "Pricing"
description: "Chroma Cloud uses a simple, transparent, usage-based pricing model. You pay for what you use across **writes**, **reads**, and **storage**—with no hidden fees or tiered feature gating."
---
...
- Forking is available on Chroma Cloud. Learn more on the [Collection Forking](https://docs.trychroma.com/cloud/collection-forking) page.
...
<AccordionGroup>
    ...
    Yes. We offer a BYOC (bring your own cloud) option for single-tenant deployments. [Contact us](https://docs.trychroma.com/cloud/) for more details.
    </Accordion>
