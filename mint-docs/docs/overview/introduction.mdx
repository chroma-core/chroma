---
title: "Chroma"
description: "**Chroma is the open-source AI application database**. Chroma makes it easy to build LLM apps by making knowledge, facts, and skills pluggable for LLMs."
...
<Frame>
<img className="block dark:hidden" src="https://docs.trychroma.com/_next/image?url=%2Fcomputer-light.png&w=1920&q=75" alt="Chroma Computer" />
<img className="hidden dark:block" src="https://docs.trychroma.com/_next/image?url=%2Fcomputer-dark.png&w=1920&q=75" alt="Chroma Computer" />
</Frame>
...
We welcome [contributions](https://docs.trychroma.com/docs/overview/contributing) for other languages!
