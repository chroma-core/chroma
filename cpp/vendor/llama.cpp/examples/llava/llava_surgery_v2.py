...
def clean_vision_tower_from_checkpoint(checkpoint_path):
    ...
    clip_tensors = [
        ...
        if (k.startswith("model.vision_tower") or k.startswith("vit."))
    ]
...
def proj_criteria(checkpoint):
    return any(
        k.startswith("model.mm_projector") or k.startswith("vision_proj.")
...
if newline_checkpoint_path is not None:
    ...
    first_mm_tensors = [
        k for k, v in first_checkpoint.items() if k.startswith("model.image_newline")
    ]
...
if projector_checkpoint_path is not None:
    ...
    mm_tensors = [
        ...
        if k.startswith("model.mm_projector") or k.startswith("vision_proj.")
    ]
