...
class QueryMetadataRequest(_message.Message):
    ...
    limit: int
    offset: int
    def __init__(self, segment_id: _Optional[str] = ..., where: _Optional[_Union[Where, _Mapping]] = ..., where_document: _Optional[_Union[WhereDocument, _Mapping]] = ..., ids: _Optional[_Iterable[str]] = ..., limit: _Optional[int] = ..., offset: _Optional[int] = ...) -> None: ...
...
class LocalSegmentMetadataTuple(_message.Message):
    __slots__ = ("embedding_id", "hnsw_label", "seq_id")
    EMBEDDING_ID_FIELD_NUMBER: _ClassVar[int]
    HNSW_LABEL_FIELD_NUMBER: _ClassVar[int]
    SEQ_ID_FIELD_NUMBER: _ClassVar[int]
    embedding_id: str
    hnsw_label: int
    seq_id: int
    def __init__(self, embedding_id: _Optional[str] = ..., hnsw_label: _Optional[int] = ..., seq_id: _Optional[int] = ...) -> None: ...

class LocalSegmentMetadata(_message.Message):
    __slots__ = ("tuples", "dimensionality", "total_elements_added", "max_seq_id")
    TUPLES_FIELD_NUMBER: _ClassVar[int]
    DIMENSIONALITY_FIELD_NUMBER: _ClassVar[int]
    TOTAL_ELEMENTS_ADDED_FIELD_NUMBER: _ClassVar[int]
    MAX_SEQ_ID_FIELD_NUMBER: _ClassVar[int]
    tuples: _containers.RepeatedCompositeFieldContainer[LocalSegmentMetadataTuple]
    dimensionality: int
    total_elements_added: int
    max_seq_id: int
    def __init__(self, tuples: _Optional[_Iterable[_Union[LocalSegmentMetadataTuple, _Mapping]]] = ..., dimensionality: _Optional[int] = ..., total_elements_added: _Optional[int] = ..., max_seq_id: _Optional[int] = ...) -> None: ...
