...
class RecordLog(_message.Message):
    ...
    def __init__(self, log_id: _Optional[int] = ..., record: _Optional[_Union[_chroma_pb2.SubmitEmbeddingRecord, _Mapping]] = ...) -> None: ...

class PullLogsResponse(_message.Message):
    __slots__ = ["records"]
    RECORDS_FIELD_NUMBER: _ClassVar[int]
    records: _containers.RepeatedCompositeFieldContainer[RecordLog]
    def __init__(self, records: _Optional[_Iterable[_Union[RecordLog, _Mapping]]] = ...) -> None: ...
