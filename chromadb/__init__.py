...
def PersistentClient(
    ...
    Args:
        path: Directory to store persisted data. If None, uses
              settings.persist_directory if set, otherwise defaults to "./chroma".
        settings: Optional settings to override defaults.
    ...
    # Priority: path parameter > settings.persist_directory > default "./chroma"
    if path is not None:
