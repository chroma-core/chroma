...
if not is_client:
    ...
    if sqlite3.sqlite_version_info < (3, 35, 0):
        raise RuntimeError(
            ...
            "\033[94mPlease install pysqlite3-binary and configure chromadb to use it:\033[0m\n"
            "\033[94m  pip install pysqlite3-binary\033[0m\n"
            "\033[94mThen add the following to your code before importing chromadb:\033[0m\n"
            "\033[94m  __import__('pysqlite3')\033[0m\n"
            "\033[94m  import sys; sys.modules['sqlite3'] = sys.modules.pop('pysqlite3')\033[0m\n"
            "\033[94mSee https://docs.trychroma.com/troubleshooting#sqlite for details.\033[0m"
        )
