...
class PersistentLocalHnswSegment(LocalHnswSegment):
    ...
    def _init_index(self, dimensionality: int) -> None:
        with self._opentelemtry_client.trace(
            "PersistentLocalHnswSegment._init_index",
    ...
    def _apply_batch(self, batch: Batch) -> None:
        with self._opentelemtry_client.trace(
            "PersistentLocalHnswSegment._apply_batch",
            OpenTelemetryGranularity.ALL,
        ):
    ...
    def _write_records(self, records: Sequence[EmbeddingRecord]) -> None:
        ...
        with self._opentelemtry_client.trace(
            "PersistentLocalHnswSegment._write_records",
            OpenTelemetryGranularity.ALL,
        ):
    ...
    def get_vectors(
        ...
        with self._opentelemtry_client.trace(
            "PersistentLocalHnswSegment.get_vectors",
            OpenTelemetryGranularity.ALL,
        ):
    ...
    def reset_state(self) -> None:
        with self._opentelemtry_client.trace(
            "PersistentLocalHnswSegment.reset_state",
            OpenTelemetryGranularity.ALL,
        ):
    ...
    def delete(self) -> None:
        with self._opentelemtry_client.trace(
            "PersistentLocalHnswSegment.delete",
            OpenTelemetryGranularity.ALL,
        ):
            data_path = self._get_storage_folder()
            if os.path.exists(data_path):
