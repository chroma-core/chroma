...
class AsyncCollection(CollectionCommon["AsyncServerAPI"]):
    ...
    async def modify(
        self, name: Optional[str] = None, metadata: Optional[CollectionMetadata] = None, configuration: Optional[UpdateCollectionConfiguration] = None
    ) -> None:
        ...
        # TODO: fixme
        await self._client._modify(id=self.id, new_name=name, new_metadata=metadata, new_configuration=configuration)
