...
from chromadb.api.types import (
    ...
    unpack_base_record_set,
    unpack_insert_record_set,
...
class CollectionCommon(Generic[ClientT]):
    ...
    def _validate_and_prepare_add_request(
        ...
        # Unpack
        add_records = unpack_insert_record_set(
            ids=ids,
    ...
    def _validate_and_prepare_query_request(
        ...
        # Unpack
        query_records = unpack_base_record_set(
    ...
    def _validate_and_prepare_update_request(
        ...
        # Unpack
        update_records = unpack_insert_record_set(
            ids=ids,
            embeddings=embeddings,
            metadatas=metadatas,
            documents=documents,
    ...
    def _validate_and_prepare_upsert_request(
        ...
        # Unpack
        upsert_records = unpack_insert_record_set(
            ids=ids,
            embeddings=embeddings,
            metadatas=metadatas,
            documents=documents,
