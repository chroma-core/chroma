...
class BaseRecordSet(TypedDict):
    """
    The base record set includes 'data' fields and embeddings.
    """
...
def unpack_insert_record_set(
    ...
    """
    base_record_set = unpack_base_record_set(
...
def validate_base_record_set(record_set: BaseRecordSet) -> None:
    ...
    if record_set["embeddings"] is not None:
        validate_embeddings(record_set["embeddings"])
    if record_set["documents"] is not None:
        validate_documents(record_set["documents"])
    if record_set["images"] is not None:
        validate_images(record_set["images"])
...
def validate_documents(documents: Documents) -> None:
