...
def validate_metadata(metadata: Metadata) -> Metadata:
    """Validates metadata to ensure it is a dictionary of strings to strings, ints, floats, bools, or lists"""
    ...
    for key, value in metadata.items():
        ...
        if not isinstance(value, bool) and not isinstance(
            ...
            raise ValueError(
                f"Expected metadata value to be a str, int, float, bool, or list, got {value} which is a {type(value)}"
            )
...
def validate_update_metadata(metadata: UpdateMetadata) -> UpdateMetadata:
    ...
    for key, value in metadata.items():
        ...
        # isinstance(True, int) evaluates to True, so we need to check for bools separately
        if not isinstance(value, bool) and not isinstance(
            value, (str, int, float, list, type(None))
        ):
            raise ValueError(
...
def validate_metadatas(metadatas: Metadatas) -> Metadatas:
    """Validates metadatas to ensure it is a list of dictionaries of strings to strings, ints, floats, bools or lists"""
