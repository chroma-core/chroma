...
chroma.set_context("yolov3", "1", "1")
# task = chroma.calculate_results("yolov3_1_1")
# print(task)
# print(chroma.get_task_status(task['task_id']))
# print(chroma.get_task_status('d8dd68eb-2f80-4056-8c16-34fbdf1fc8ad'))
# chroma.reset()
# print(chroma.raw_sql('SELECT * FROM results;'))
...
# chroma.log([[1,2,3,4,5]], ["/images/1"], ["training"], ['spoon'])
# chroma.log([[1,2,3,4,5]], ["/images/2"], ["training"], ['spoon'])
# chroma.log([[1,2,3,4,5]], ["/images/3"], ["training"], ['spoon'])

# chroma.set_context("test", "1", "55")
# chroma.log([[1,2,3,4,5]], ["/images/1"], ["training"], ['knife'])
# chroma.log([[1,2,3,4,5]], ["/images/4"], ["training"], ['knife'])
# chroma.log([[1,2,3,4,5]], ["/prod/2"], ["test"], ['knife'])

# print(chroma.raw_sql('SELECT DISTINCT space_key FROM embeddings;'))
# chroma.log([[1,2,3,4,5]], ["/images/4"], ["training"], ['spoon'])
# chroma.log([[1,2,3,4,5]], ["/prod/1"], ["test"], ['spoon'])
# chroma.log([[1,2,3,4,5]], ["/prod/2"], ["test"], ['spoon'])
