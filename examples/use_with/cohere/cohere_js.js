...
const main = async () => {
  ...
  const cohereAIEmbedder = new chroma.CohereEmbeddingFunction({
  ...
  const cohereAIMulitlingualEmbedder = new chroma.CohereEmbeddingFunction({
    cohere_api_key: COHERE_API_KEY,
  ...
  let ids = Array.from({ length: multilingual_texts.length }, (_, i) =>
    String(i),
  );
