...
class Dataset(Base):
    ...
    id: int = Column(Integer, primary_key=True, index=True)
    name = Column(String)
    # [x] has many slices, has many datapoints, belongs_to project
...
class Slice(Base):
    ...
    id: int = Column(Integer, primary_key=True, index=True)
    name = Column(String)
    # [x] habtm datapoints, belongs_to dataset, has_many trained_models
...
class Datapoint(Base):
    ...
    id: int = Column(Integer, primary_key=True, index=True)
    # [x] belongs to dataset, has one resource, has one label, has one inference, habtm tags, habtm slices
    dataset_id: Optional[int] = Column(Integer, ForeignKey(Dataset.id), nullable=True)
...
class Inference(Base):
    ...
    id: int = Column(Integer, primary_key=True, index=True)
    # [x] has one trained model, has_one datapoint
    datapoint_id: Optional[int] = Column(Integer, ForeignKey(Datapoint.id), nullable=True)
...
class ModelArchitecture(Base):
    ...
    id: int = Column(Integer, primary_key=True, index=True)
    name = Column(String)
    # [x] has many trained models, belongs_to project
...
class TrainedModel(Base):
    ...
    id: int = Column(Integer, primary_key=True, index=True)
    # [x] has many layersets, belongs_to modelarchitecture, has one slice
...
class LayerSet(Base):
    ...
    id: int = Column(Integer, primary_key=True, index=True)
    # [x] has many layers, belongs_to trained model
...
class Layer(Base):
    ...
    id: int = Column(Integer, primary_key=True, index=True)
    # [x] has many embeddings, belongs_to layerset
...
class ProjectionSet(Base):
    ...
    id: int = Column(Integer, primary_key=True, index=True)
    # [x] belongs_to embedding_set
    # [x] has_many projections
...
class Projection(Base):
    ...
    # [x] belongs_to embedding
    # [x] belongs_to projection_set
