...
k8s_resource('rust-log-service:statefulset:chroma', labels=["chroma"], port_forwards=['50054:50051', '50052:50052'], resource_deps=['minio-deployment'] + (['rust-sysdb-migration-latest'] if  os.environ.get('MULTI_REGION') == 'true' else []))
...
k8s_resource('rust-log-service:statefulset:chroma2', labels=["chroma2"], port_forwards=['60054:50051', '60052:50052'], resource_deps=['minio-deployment', 'rust-sysdb-migration-latest'])
