...
k8s_resource('rust-sysdb-service:deployment:chroma', resource_deps=['k8s_setup'], labels=["chroma"])
...
k8s_resource('rust-sysdb-service:deployment:chroma2', resource_deps=['k8s_setup2'], labels=["chroma2"])
