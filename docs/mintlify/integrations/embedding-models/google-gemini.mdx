...
# The GoogleGenaiEmbeddingFunction expects the API key in the GEMINI_API_KEY environment variable.
...
import (
    ...
    g "github.com/chroma-core/chroma/clients/go/pkg/embeddings/gemini"
)
