...
classes or functions, we can subsequently retrieve the chunks where they are represented (via [regex](../../oss/querying-collections/full-text-search.md) search for example).
