...
<Columns cols={3}>
  <Card title="Document Storage" icon="database" href="/oss/collections/add-data">
    Store documents and metadata.
  </Card>
  <Card title="Embeddings" icon="microchip" href="/oss/embeddings/embedding-functions">
    Use any embedding model. OpenAI, Cohere, Hugging Face, sentence-transformers, and more.
  </Card>
  <Card title="Vector Search" icon="magnifying-glass" href="/oss/querying-collections/query-and-get">
    Dense, sparse, and hybrid search. Query by similarity and combine multiple search strategies.
  </Card>
  <Card title="Full-Text & Regex Search" icon="font" href="/oss/querying-collections/full-text-search">
    Keyword and regex search over your data without embeddings.
  </Card>
  <Card title="Metadata Filtering" icon="filter" href="/oss/querying-collections/metadata-filtering">
    Filter results at query time by metadata conditions.
  </Card>
  <Card title="Multi-Modal Retrieval" icon="image" href="/oss/embeddings/multimodal">
...
<Columns cols={2}>
  <Card title="Getting Started with the Chroma SDK" icon="python" iconType="brands" href="/oss/overview/getting-started">
