---
title: "Architecture"
description: "Chroma is designed with a modular architecture that prioritizes performance and ease of use. It scales seamlessly from local development to large-scale production, while exposing a consistent API across all deployment modes."
---
...
<Frame>
<img className="block dark:hidden" src="/images/read-path-light.png" alt="Chroma System Read Path" />
<img className="hidden dark:block" src="/images/read-path-dark.png" alt="Chroma System Read Path" />
</Frame>
...
<Frame>
<img className="block dark:hidden" src="/images/write-path-light.png" alt="Chroma System Write Path" />
<img className="hidden dark:block" src="/images/write-path-dark.png" alt="Chroma System Write Path" />
</Frame>
