...
| [Perplexity](../../integrations/embedding-models/perplexity)                             | ✓      | ✓          | ✓  |
| [Sentence Transformers](../../integrations/embedding-models/sentence-transformer)        | ✓      | ✓          | -  |
| [Amazon Bedrock](../../integrations/embedding-models/amazon-bedrock)                     | ✓      | -          | ✓  |
...
func (ef *MyEmbeddingFunction) EmbedDocuments(ctx context.Context, docs []string) (embeddings.Embeddings, error) {
    ...
    for i := range docs {
        result[i] = embeddings.NewFloat32Embedding([]float32{0.1, 0.2, 0.3})
    }
    return result, nil
}
