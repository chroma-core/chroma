...
| [OCI Generative AI](../../integrations/embedding-models/oci-generative-ai)               | ✓      | ✓          |
...
| OCI Generative AI           | [@chroma-core/oci-genai](https://www.npmjs.com/package/@chroma-core/oci-genai)
