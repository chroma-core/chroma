...
Use the Search API to filter on document content. You can combine `contains` and regex filters with metadata conditions.
...
let search = SearchPayload::default()
    .r#where(Key::Document.contains("search string"))
    .rank(RankExpr::Knn {
