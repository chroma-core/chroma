...
import googleGeminiSchema from "../../../../../../schemas/embedding_functions/google_gemini.json";
...
import ociGenaiSchema from "../../../../../../schemas/embedding_functions/oci_genai.json";
import Ajv from "ajv";
...
const schemaMap = {
	...
	"google-gemini": googleGeminiSchema as Schema,
	"google-genai": googleGenaiSchema as Schema, // Backward compatibility alias
	...
	"oci-genai": ociGenaiSchema as Schema,
};
