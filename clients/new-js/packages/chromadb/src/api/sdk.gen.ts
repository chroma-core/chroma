...
export class DefaultService {
     ...
     */
    public static collectionIndexingStatus<ThrowOnError extends boolean = true>(options: Options<CollectionIndexingStatusData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).get<CollectionIndexingStatusResponse, CollectionIndexingStatusError, ThrowOnError>({
