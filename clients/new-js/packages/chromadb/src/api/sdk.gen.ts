...
export class CollectionService {
    ...
    /**
     * Search collections
     * Finds the collections of a given name across every database in a tenant. Each returned collection names the database that holds it.
     */
    public static searchCollections<ThrowOnError extends boolean = true>(options: Options<SearchCollectionsData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).get<SearchCollectionsResponse, SearchCollectionsError, ThrowOnError>({
            security: [
                {
                    name: 'x-chroma-token',
                    type: 'apiKey'
...
export class DatabaseService {
     ...
     */
    public static getDatabaseById<ThrowOnError extends boolean = true>(options: Options<GetDatabaseByIdData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).get<GetDatabaseByIdResponse, GetDatabaseByIdError, ThrowOnError>({
            security: [
                {
                    name: 'x-chroma-token',
                    type: 'apiKey'
...
export class RecordService {
    ...
    /**
     * Conditional get
     * Returns records from a collection and includes the OCC read token for conditional transactions.
     */
    public static collectionConditionalGet<ThrowOnError extends boolean = true>(options: Options<CollectionConditionalGetData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).post<CollectionConditionalGetResponse, CollectionConditionalGetError, ThrowOnError>({
            security: [
                {
                    name: 'x-chroma-token',
                    type: 'apiKey'
