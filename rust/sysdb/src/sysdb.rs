...
impl GrpcSysDb {
    ...
    pub async fn get_collections_to_gc(
        ...
        // We can either adjust the second request limit based on the number of collections we got from
        // the legacy sysdb or accept potentially getting a double of the requested limit.

        // Append collections from rust-sysdb (mcmr_client) — a separate sysdb instance
