        ...
        backend
            ...
            .read_write_transaction::<(), SysDbError, _>(|tx| {
                Box::pin({
                    ...
                    async move {
                        let mut stmt = Statement::new(
                            "INSERT INTO collection_compaction_cursors (collection_id, region, version_file_name, last_compaction_time_secs, num_versions) VALUES (@collection_id, @region, @version_file_name, @last_compaction_time_secs, @num_versions)"
                        );
