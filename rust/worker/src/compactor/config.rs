...
pub struct CompactorConfig {
    ...
    #[serde(default = "CompactorConfig::default_disabled_function_collections")]
    ...
    #[serde(default = "CompactorConfig::default_use_pointer_fetch")]
...
impl CompactorConfig {
    ...
    fn default_disabled_function_collections() -> Vec<String> {
        vec![]
    }
...
impl Default for CompactorConfig {
    fn default() -> Self {
        CompactorConfig {
            ...
            use_pointer_fetch: CompactorConfig::default_use_pointer_fetch(),
        }
    }
}
