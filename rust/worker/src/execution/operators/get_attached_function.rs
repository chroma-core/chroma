...
use chroma_types::{
    AttachedFunction, Collection, CollectionUuid, GetCollectionByCrnError,
...
impl ChromaError for GetAttachedFunctionError {
    fn code(&self) -> chroma_error::ErrorCodes {
        match self {
            ...
            GetAttachedFunctionError::ConversionError => chroma_error::ErrorCodes::Internal,
        }
    }
    ...
    fn should_trace_error(&self) -> bool {
        match self {
            ...
            GetAttachedFunctionError::ConversionError => true,
        }
    }
}
...
impl ChromaError for GetAttachedFunctionOperatorError {
    fn code(&self) -> chroma_error::ErrorCodes {
        match self {
            ...
            GetAttachedFunctionOperatorError::ConversionError => chroma_error::ErrorCodes::Internal,
    ...
    fn should_trace_error(&self) -> bool {
        match self {
            ...
            GetAttachedFunctionOperatorError::ConversionError => true,
...
impl Operator<GetAttachedFunctionInput, GetAttachedFunctionOutput> for GetAttachedFunctionOperator {
    ...
    async fn run(
        ...
        let attached_function: AttachedFunction = attached_function_proto
            .try_into()
            .map_err(|_| GetAttachedFunctionOperatorError::ConversionError)?;
