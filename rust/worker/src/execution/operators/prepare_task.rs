    ...
    for PrepareAttachedFunctionOperator
{
    ...
    async fn run(
        ...
        let should_skip_execution = new_records_count < attached_function.min_records_for_run;
        ...
        if should_skip_execution {
            tracing::info!(
                ...
                attached_function.name,
                new_records_count,
                attached_function.min_records_for_run
            );
        } else {
            tracing::info!(
