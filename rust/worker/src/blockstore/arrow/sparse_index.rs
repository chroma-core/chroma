// use crate::blockstore::key::StoredBlockfileKey;
...
//     pub(super) fn get_target_block_id(&self, search_key: &StoredBlockfileKey) -> Uuid {
...
//     pub(super) fn add_block(&mut self, start_key: StoredBlockfileKey, block_id: Uuid) {
//         self.forward
...
//         old_block_id: Uuid,
//         new_block_id: Uuid,
//         new_start_key: StoredBlockfileKey,
//     ) {
...
//             StoredBlockfileKey::new("prefix".to_string(), Key::String("a".to_string()));
//         sparse_index.add_block(blockfile_key.clone(), block_id_1);
//         assert_eq!(sparse_index.get_target_block_id(&blockfile_key), block_id_1);

//         blockfile_key = StoredBlockfileKey::new("prefix".to_string(), Key::String("b".to_string()));
//         assert_eq!(sparse_index.get_target_block_id(&blockfile_key), block_id_1);

//         // Split the range into two blocks (start, c), and (c, end)
//         let block_id_2 = uuid::Uuid::new_v4();
//         blockfile_key = StoredBlockfileKey::new("prefix".to_string(), Key::String("c".to_string()));
...
//         blockfile_key = StoredBlockfileKey::new("prefix".to_string(), Key::String("d".to_string()));
//         assert_eq!(sparse_index.get_target_block_id(&blockfile_key), block_id_2);

//         // Split the second block into (c, f) and (f, end)
//         let block_id_3 = uuid::Uuid::new_v4();
//         blockfile_key = StoredBlockfileKey::new("prefix".to_string(), Key::String("f".to_string()));
...
//         blockfile_key = StoredBlockfileKey::new("prefix".to_string(), Key::String("g".to_string()));
//         assert_eq!(sparse_index.get_target_block_id(&blockfile_key), block_id_3);
