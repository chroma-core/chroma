...
pub struct ChromaClient {
    ...
    resolve_tenant_or_database_semaphore: Arc<tokio::sync::Semaphore>,
...
impl Clone for ChromaClient {
    fn clone(&self) -> Self {
        ChromaClient {
            ...
            resolve_tenant_or_database_semaphore: Arc::new(tokio::sync::Semaphore::new(1)),
            #[cfg(feature = "opentelemetry")]
...
impl ChromaClient {
    ...
    async fn get_database_id(
        ...
        let _permit = self
            .resolve_tenant_or_database_semaphore
            .clone()
            .acquire_owned()
            .await
