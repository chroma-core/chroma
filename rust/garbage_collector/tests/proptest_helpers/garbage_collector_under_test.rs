...
impl StateMachineTest for GarbageCollectorUnderTest {
    ...
    fn check_invariants(
        ...
        let _ = ref_state.runtime.block_on({
                    ...
                    .map(move |(collection_id, expected_versions)| {
                        ...
                        async move {
                            ...
                            assert_eq!(
                                ...
                                "Version file for collection {} does not match expected versions.",
                                collection_id,
                            );
                        }
                    })
