...
mod tests {
    ...
    fn post_process_fragments_uses_from_position_for_record_limits() {
        ...
        assert_eq!(result_strict[0].seq_no, FragmentIdentifier(1));
        assert_eq!(result_strict[1].seq_no, FragmentIdentifier(2));
        assert!(short_read);
    }
    ...
    fn records_based_pruning_bug_from_commit_message() {
        ...
        assert_eq!(result[0].seq_no, FragmentIdentifier(1));
        assert_eq!(result[1].seq_no, FragmentIdentifier(2));
        assert!(!short_read);
        ...
        assert_eq!(result_edge[0].seq_no, FragmentIdentifier(1));
        assert!(short_read);
    }
    ...
    fn scan_from_manifest_cached_manifest_boundary_conditions() {
        ...
        let manifest = Manifest {
            ...
            initial_seq_no: Some(FragmentIdentifier(1)),
        };
